export const config = {
	mapTitle: 'young-people-poverty', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-young-people-poverty.vercel.app/', // The url provided when deploying the map on Vercel
